...
- Minimal docs (good for agents): https://hypertext.wiki/llms.txt 
- Full corpus (good for deep research): https://hypertext.wiki/llms-full.txt
...
- [Cybernetics Reading List](/data/reddit/posts/hyperprompting/260629-what-cybernetics-books-are-you-reading.md): Foundational cybernetics books and study approach
